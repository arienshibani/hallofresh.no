...
<section class="bg-white dark:bg-gray-900 mb-96 mt-12">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div>
            <img class="flex m-auto max-w-2xl" src="comparison-table.png" alt="">
        </div>

        <a href="/info">
            <div class="flex"> 
                <button class="m-auto border border-black border-r-4 border-b-4  rounded-sm h-10 w-fit pr-4 pl-4 mt-20 mb-20" >
